          ...
          <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
            <div className="pt-16 pb-8 px-4 text-center text-white bg-gray-800 rounded shadow">
              ...
              <div>
                ...
                <a
                  className="block sm:inline-block py-4 px-6 text-xs text-white text-center font-semibold leading-none border border-gray-500 hover:border-gray-400 rounded"
                  href="#"
                >
                  Purchase
                </a>
